...
Route::get('/v1/nouser', [App\Http\Controllers\ApiController::class, 'noUserRegister'])->name('noUserRegister');
Route::post('/v1/nouser', [App\Http\Controllers\ApiController::class, 'noUserRegister'])->name('noUserRegister');
